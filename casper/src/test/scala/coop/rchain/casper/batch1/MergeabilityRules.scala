...
trait MergeabilityRules {
  ...
  val S1on1 = Rho("@1!(1)")
  val R0on1 = Rho("@1!!(0)")
  val F_on1 = Rho("for (_ <- @1) { 0 }")
  val C_on1 = Rho("contract @1(id) = { 0 }")
  val P_on1 = Rho("for (_ <<- @1) { 0 }")
  ...
  /**
    ...
    *
    * 4! C!
    * "!X !4"    -> MergeableCase(S0)(F_)(S1)(S0.rstate),
    *
    *           MergedBlock
    *       /                         \
  ...
  val baseMergeabilityCases = List(
    ...
    "!X (4!!)" -> ConflictingCase(S0)(F_, R0)(Nil)(S0.rstate)(R0.rstate),
    "!X !!X"   -> MergeableCase(S0)(R0)(Nil)(S0.rstate ++ R0.rstate),
    "!X !!4"   -> ConflictingCase(S0)(F1)(R1)(S0.rstate ++ R1.rstate)(R1.rstate),
    "!X (!!4)" -> CoveredBy("!X (4!!)"),
...
//    "!4 (!4)"    -> NonDeterminedUnknownCase(F0)(S1, F_)(S0)(emptyState)(emptyState),
    ...
    "!4 (!C)"    -> ConflictingCase(F0)(C1, S1)(S0)(emptyState)(C1.rstate ++ S0.rstate),
    "!4 4X"      -> MergeableCase(F0)(Nil)(S0, F1)(F1.rstate),
    "(!4) 4X"    -> MergeableCase(S0, F_)(Nil)(F1)(F1.rstate),
    "!4 4!"      -> ConflictingCase(S0)(F_)(F0, S1)(S1.rstate)(F0.rstate),
    "(!4) (4!)"  -> MergeableCase(S0, F_)(S0, F_)(Nil)(emptyState),
    "!4 (4!)"    -> CoveredBy("!4 (!4)"),
    "(!4) 4!"    -> MergeableCase(S1, F1)(S0)(F0)(emptyState),
    "!4 4!!"     -> ConflictingCase(F0)(R1)(S0, F1)(F1.rstate)(R1.rstate ++ S0.rstate),
    "(!4) 4!!"   -> MergeableCase(F0, S0)(R1)(F1)(R1.rstate),
    "!4 (4!!)"   -> ConflictingCase(F0)(R1, F1)(S0)(emptyState)(S0.rstate ++ R1.rstate),
...
//    "!4 (!!4)"   -> NonDeterminedConflictCase(F_)(F1, R1)(S0)(emptyState)(R1.rstate ++ S0.rstate),
    "!4 (!!4)"   -> ConflictingCase(F0)(F1, R1)(S0)(emptyState)(R1.rstate ++ S0.rstate),
    ...
    "!4 C!"      -> ConflictingCase(F0)(S1)(S0, C1)(C1.rstate)(S0.rstate ++ C1.rstate),
...
//    "(!4) C!"    -> NonDeterminedMergeableCase(S0, F0)(S1)(C_)(C_.rstate)(C_.rstate),
    ...
    "!C (!C)"    -> ConflictingCase(C0)(C1, S1)(S0)(C0.rstate)(C1.rstate ++ S0.rstate),
    "(!C) !C"    -> CoveredBy("!C (!C)"),
    "(!C) (!C)"  -> ConflictingCase(S0, C_)(S0, C_)(Nil)(C_.rstate)(C_.rstate),
    "!C 4X"      -> MergeableCase(C_)(Nil)(S0, F1)(C_.rstate ++ F1.rstate),
    "(!C) 4X"    -> ConflictingCase(S0, C_)(F_)(Nil)(C_.rstate)(F_.rstate),
    "!C 4!"      -> ConflictingCase(C0)(S1)(S0, F1)(C0.rstate ++ F1.rstate)(S0.rstate),
//    "(!C) 4!"   -> NonDeterminedConflictCase(S0, C_)(S0)(F_)(C_.rstate ++ F_.rstate)(emptyState),
    ...
    "!C 4!!" -> ConflictingCase(C0)(R1)(S0, F1)(C0.rstate ++ F1.rstate)(
      R1.rstate ++ S0.rstate
    ),
    "!C 4!! 2" -> ConflictingCase(C_)(R1)(S0, F1)(C_.rstate ++ F1.rstate)(
      R1.rstate ++ S0.rstate
    ),
    "(!C) 4!!"     -> ConflictingCase(C0, S0)(R1)(F1)(C0.rstate ++ F1.rstate)(R1.rstate),
    "(!C) 4!! 2"   -> ConflictingCase(C_, S0)(R1)(F1)(C_.rstate ++ F1.rstate)(R1.rstate),
    "!C (4!!)"     -> ConflictingCase(C0)(R1, F1)(S0)(C0.rstate)(R1.rstate ++ S0.rstate),
    "!C (4!!) 2"   -> ConflictingCase(C_)(R1, F1)(S0)(C_.rstate)(R1.rstate ++ S0.rstate),
    "(!C) (4!!)"   -> ConflictingCase(C0, S0)(R1, F1)(Nil)(C0.rstate)(R1.rstate),
    ...
    "(!C) CX"      -> ConflictingCase(S0, C0)(C_)(Nil)(C0.rstate)(C_.rstate),
    "!C C!"        -> ConflictingCase(S0)(C_)(C0, S1)(S1.rstate ++ C0.rstate)(C0.rstate ++ C_.rstate),
    "(!C) C!"      -> ConflictingCase(S0, C_)(C_)(S0)(C_.rstate)(C_.rstate),
    "!C (C!)"      -> CoveredBy("!C (!C)"),
    "(!C) (C!)"    -> ConflictingCase(S0, C_)(C_, S0)(Nil)(C_.rstate)(C_.rstate),
    ...
    "4X (4!!)"     -> ConflictingCase(F1)(R0, F0)(Nil)(F1.rstate)(R0.rstate),
    "4X (4!!) 2"   -> ConflictingCase(F0)(R0, F0)(Nil)(F0.rstate)(R0.rstate),
    "4X !!X" -> ConflictingCase(S0)(F1)(F1, R0)(F1.rstate ++ S0.rstate ++ R0.rstate)(
    ...
    "4X C!"    -> ConflictingCase(F0)(S1)(C1)(C1.rstate ++ F0.rstate)(C1.rstate),
    "4X (C!)"  -> ConflictingCase(F_)(C_, S0)(Nil)(F_.rstate)(C_.rstate),
...
//    "(4!) 4!"    -> NonDeterminedUnknownCase(F1, S1)(S0)(F_)(emptyState)(emptyState),
    ...
    "(4!) (4!!)" -> MergeableCase(F0, S0)(F1, R1)(Nil)(R1.rstate),
    "(4!) 4!!"   -> MergeableCase(F0, S0)(R1)(F1)(R1.rstate),
    "4! (4!!)"   -> ConflictingCase(S0)(F1, R1)(F0)(emptyState)(F0.rstate ++ R1.rstate),
    "4! !!X"     -> MergeableCase(S0)(R1)(F0)(R1.rstate),
    "(4!) !!X"   -> MergeableCase(S0, F0)(R1)(Nil)(R1.rstate),
    "4! !!4"     -> ConflictingCase(S1)(F0)(F1, R0)(R0.rstate)(F1.rstate ++ R0.rstate),
    "(4!) !!4"   -> MergeableCase(S1, F1)(F0)(R0)(R0.rstate),
    "(4!) (!!4)" -> CoveredBy("(4!) (4!!)"),
    "4! (!!4)"   -> ConflictingCase(S1)(F0, R0)(F1)(emptyState)(R0.rstate ++ F1.rstate),
    ...
    "4! CX"      -> ConflictingCase(S0)(C1)(F_)(emptyState)(C1.rstate ++ F_.rstate),
...
//    "(4!) C!"    -> NonDeterminedConflictCase(F1, S1)(S0)(C_)(C_.rstate)(C_.rstate),
    ...
    "(4!!) (4!!)" -> ConflictingCase(R1, F1)(R0, F0)(Nil)(R1.rstate)(R0.rstate),
    "(4!!) 4!!"   -> ConflictingCase(R1, F1)(R0)(F_)(R1.rstate)(R0.rstate),
    "(4!!) 4!!"   -> ConflictingCase(R1, F1)(R0)(F0)(R1.rstate ++ F0.rstate)(R0.rstate),
    ...
    "4!! !!4"     -> ConflictingCase(R0)(F1)(F0, R1)(R1.rstate ++ R0.rstate)(F0.rstate ++ R1.rstate),
    "(4!!) !!4"   -> ConflictingCase(R0, F0)(F1)(R1)(R1.rstate ++ R0.rstate)(R1.rstate),
    "4!! (!!4)"   -> CoveredBy("(4!!) !!4"),
    "(4!!) (!!4)" -> ConflictingCase(R0, F0)(F1, R1)(Nil)(R0.rstate)(R1.rstate),
    "(4!!) (!!4)" -> ConflictingCase(R0, F_)(F1, R1)(Nil)(R0.rstate)(R1.rstate),
    ...
    "4!! CX"      -> ConflictingCase(R1)(C0)(F1)(R1.rstate)(C0.rstate ++ F1.rstate),
    "4!! CX 2"    -> ConflictingCase(R1)(C_)(F1)(R1.rstate)(C_.rstate ++ F1.rstate),
    "(4!!) CX"    -> ConflictingCase(R1, F1)(C_)(Nil)(R1.rstate)(C_.rstate),
    "(4!!) CX 2"  -> ConflictingCase(R1, F1)(C0)(Nil)(R1.rstate)(C0.rstate),
...
//    "(4!!) C! 2"   -> NonDeterminedMergeableCase(R1, F_)(C_)(S0)(emptyState)(emptyState),
    "4!! (C!)"     -> ConflictingCase(R1)(C0, S0)(F1)(R1.rstate)(C0.rstate ++ F1.rstate),
    "4!! (C!) 2"   -> ConflictingCase(R1)(C_, S0)(F1)(R1.rstate)(C_.rstate ++ F1.rstate),
    "(4!!) (C!)"   -> ConflictingCase(R1, F1)(C0, S0)(Nil)(R1.rstate)(C0.rstate),
    ...
    "!!X C!" -> ConflictingCase(F1)(S1)(R0, C1)(C1.rstate ++ R0.rstate ++ F1.rstate)(
      R0.rstate ++ C1.rstate
    ),
    "!!X (C!)"     -> ConflictingCase(F1)(S1, C1)(R0)(F1.rstate ++ R0.rstate)(C1.rstate ++ R0.rstate),
    ...
    "(!!4) (!!4)"  -> ConflictingCase(F1, R1)(F0, R0)(Nil)(R1.rstate)(R0.rstate),
    ...
    "!!4 C!"       -> ConflictingCase(F0)(S1)(R0, C1)(R0.rstate ++ C1.rstate)(R0.rstate ++ C1.rstate),
    "(!!4) C!"     -> ConflictingCase(F0, R0)(S1, C1)(Nil)(R0.rstate)(C1.rstate),
    "!!4 (C!)"     -> ConflictingCase(F0)(S1, C1)(R0)(R0.rstate)(R0.rstate ++ C1.rstate),
    "(!!4) (C!)"   -> ConflictingCase(F0, R0)(S1, C1)(Nil)(R0.rstate)(C1.rstate),
    ...
    "CX (C!)"      -> ConflictingCase(C_)(C_, S0)(Nil)(C_.rstate)(C_.rstate),
    ...
    "(C!) C!"      -> ConflictingCase(C0, S0)(S0)(C_)(C_.rstate ++ C0.rstate)(C_.rstate),
    "C! (C!)"      -> CoveredBy("(C!) C!"), // ?
    "(C!) (C!)"    -> ConflictingCase(C_, S0)(C_, S0)(Nil)(C_.rstate)(C_.rstate),
  ...
  val peekMergeabilityCases = List(
    ...
    "PX (!C)"  -> ConflictingCase(P1)(C_, S0)(Nil)(P1.rstate)(C_.rstate),
    "PX 4X"    -> MergeableCase(F_)(P_)(Nil)(F_.rstate ++ P_.rstate),
    "PX 4!"    -> MergeableCase(F_)(P1)(S0)(P1.rstate),
    "PX (4!)"  -> CoveredBy("PX (!4)"),
    "PX 4!!"   -> ConflictingCase(P0)(R1)(F1)(P0.rstate ++ F1.rstate)(R1.rstate),
    "PX (4!!)" -> ConflictingCase(P0)(R1, F1)(Nil)(P0.rstate)(R1.rstate),
    ...
    "PX (C!)"  -> ConflictingCase(P_)(C_, S0)(Nil)(P_.rstate)(C_.rstate),
    "PX C!!"   -> InfiniteLoop(P1)(R0)(C0)(P1.rstate ++ C0.rstate),
    "PX C!!"   -> CoveredBy("PX (!!C)"),
    "P! !X"    -> ConflictingCase(S0)(P_)(S0)(S0.rstate ++ S0.rstate)(S0.rstate),
    "(P!) !X"  -> MergeableCase(S0)(P_, S0)(Nil)(S0.rstate ++ S0.rstate),
    "!P !X"    -> MergeableCase(S0)(S1)(P1)(S0.rstate ++ S1.rstate),
    "(!P) !X"  -> CoveredBy("(P!) !X"),
    "P! !4"    -> ConflictingCase(S1)(F0)(S0, P1)(S1.rstate ++ S0.rstate)(P1.rstate),
//    "(P!) !4"  -> NonDeterminedCase(P_, S1)(F0)(S0)(emptyState)(emptyState),
    "(P!) !4 2" -> ConflictingCase(P1, S1)(F0)(S0)(S1.rstate ++ S0.rstate)(emptyState),
//    "P! (!4)"   -> NonDeterminedUnknownCase(S0, F0)(S1)(P_)(emptyState)(emptyState),
    ...
    "!P (!4)"   -> MergeableCase(F0)(P1)(S0, S1)(S1.rstate),
    "(!P) (!4)" -> CoveredBy("(P!) (!4)"),
    "P! !C" -> ConflictingCase(S0)(C1)(P0, S1)(S0.rstate ++ S1.rstate)(
      C1.rstate ++ P0.rstate
    ),
...
//    "P! (4!) 2" -> NonDeterminedConflictCase(S1)(F0, S0)(P_)(emptyState)(emptyState),
    ...
    "!P 4!"     -> ConflictingCase(P_)(S0)(F0, S1)(S1.rstate ++ F0.rstate)(S1.rstate),
    "(!P) 4!"   -> CoveredBy("(P!) 4!"),
...
//    "(P!) 4!!" -> NonDeterminedConflictCase(S1, P1)(R1)(F1)(emptyState)(emptyState),
    ...
    "P! (4!!)"   -> ConflictingCase(S0)(R1, F1)(P0)(S0.rstate)(P0.rstate ++ R1.rstate),
    "(P!) (4!!)" -> ConflictingCase(S1, P1)(R1, F1)(Nil)(S1.rstate)(R1.rstate),
    "!P 4!!"     -> ConflictingCase(P0)(R1)(S0, F1)(S0.rstate ++ F1.rstate)(S0.rstate ++ R1.rstate),
    "(!P) 4!!"   -> CoveredBy("(P!) 4!!"),
    "!P (4!!)"   -> ConflictingCase(P0)(R1, F1)(S0)(S0.rstate)(R1.rstate ++ S0.rstate),
    "(!P) (4!!)" -> CoveredBy("(P!) (4!!)"),
...
//    "P! (P!)"    -> NonDeterminedUnknownCase(S0)(P1, S1)(P_)(emptyState)(emptyState),
    ...
    "P! !P"      -> ConflictingCase(S0)(P1)(P0, S1)(S0.rstate ++ S1.rstate)(S1.rstate ++ P0.rstate),
    "P! (!P)"    -> CoveredBy("P! (P!)"),
    "(P!) !P"    -> ConflictingCase(P_)(P0, S0)(S1)(S1.rstate)(S1.rstate ++ S0.rstate),
    "(P!) (!P)"  -> CoveredBy("(P!) (P!)"),
    ...
    "P! (P!!)"   -> ConflictingCase(S0)(R1, P1)(P0)(S0.rstate)(R1.rstate ++ P0.rstate),
    "P! (P!!)"   -> ConflictingCase(S0)(R1, S1)(P_)(S0.rstate)(R1.rstate ++ S1.rstate),
    "(P!) (P!!)" -> ConflictingCase(P_, S0)(R1, P_)(Nil)(S0.rstate)(R1.rstate),
    "!P P!!"     -> ConflictingCase(P1)(R0)(S1, P0)(S1.rstate ++ P0.rstate)(R0.rstate ++ S1.rstate),
    "(!P) P!!"   -> CoveredBy("(P!) P!!"),
    "!P (P!!)"   -> ConflictingCase(P_)(P_, R0)(S1)(S1.rstate)(R0.rstate ++ S1.rstate),
    "(!P) (P!!)" -> CoveredBy("(P!) (P!!)"),
    "!P !!P"     -> MergeableCase(P0)(P1)(S0, R1)(S0.rstate ++ R1.rstate),
    "(!P) !!P"   -> ConflictingCase(P_, S0)(P_)(R0)(S0.rstate ++ R0.rstate)(R0.rstate),
    "!P (!!P)"   -> CoveredBy("!P (P!!)"),
    "(!P) (!!P)" -> CoveredBy("(P!) (P!!)"),
    "P! !!X"     -> MergeableCase(S1)(R0)(P0)(R0.rstate ++ S1.rstate),
    "(P!) !!X"   -> MergeableCase(S1, P_)(R0)(Nil)(S1.rstate ++ R0.rstate),
    "!P !!X"     -> ConflictingCase(P_)(R1)(S0)(S0.rstate)(R1.rstate ++ S0.rstate),
    "(!P) !!X"   -> CoveredBy("(P!) !!X"),
    "P! !!4"     -> ConflictingCase(S0)(F_)(P0, R1)(R1.rstate ++ S0.rstate)(R1.rstate ++ P0.rstate),
    "(P!) !!4"   -> ConflictingCase(S0, P0)(F_)(R1)(R1.rstate ++ S0.rstate)(R1.rstate),
    "P! (!!4)"   -> ConflictingCase(S0)(F_, R1)(P0)(S0.rstate)(R1.rstate ++ P0.rstate),
...
//    "!P !!4"     -> NonDeterminedUnknownCase(P0)(F_)(S0, R1)(emptyState)(emptyState),
    ...
    "(!P) !!4"   -> CoveredBy("(!P) !!4"),
    "!P (!!4)"   -> ConflictingCase(P0)(F1, R1)(S0)(S0.rstate)(R1.rstate ++ S0.rstate),
    "(!P) (!!4)" -> CoveredBy("(P!) (4!!)"),
    ...
    "P! CX"      -> ConflictingCase(S0)(C1)(P_)(S0.rstate)(C1.rstate ++ P_.rstate),
...
//    "P! C!"      -> NonDeterminedUnknownCase(S0)(S0)(P_, C_)(emptyState)(emptyState),
    ...
    "P! (C!)" -> ConflictingCase(S1)(C0, S0)(P1)(S1.rstate)(C0.rstate ++ P1.rstate),
...
//    "(P!) C! 2"  -> NonDeterminedUnknownCase(S1)(P0, S0)(C_)(emptyState)(emptyState),
    ...
    "!P C!"      -> ConflictingCase(P_)(S1)(S0, C1)(S0.rstate ++ C1.rstate)(S0.rstate ++ C1.rstate),
    "!P (C!)"    -> ConflictingCase(P_)(C0, S0)(S1)(S1.rstate)(C0.rstate ++ S1.rstate),
    "(!P) C!"    -> CoveredBy("(P!) C!"),
    "(!P) (C!)"  -> CoveredBy("(P!) (C!)"),
    ...
    "(P!!) !X "  -> ConflictingCase(S0)(P_, R0)(Nil)(S0.rstate)(R0.rstate),
    "!!P !X"     -> MergeableCase(Nil)(P0)(R0, S1)(R0.rstate ++ S1.rstate),
    "(!!P) !X"   -> CoveredBy("!!P !X"),
    "P!! !4"     -> ConflictingCase(F0)(R1)(S0, P1)(P1.rstate)(R1.rstate ++ S0.rstate),
...
//    "!!P !4"     -> NonDeterminedUnknownCase(F0)(P_)(S0, R1)(emptyState)(emptyState),
    ...
    "(P!!) !C"   -> ConflictingCase(C0)(R1, P1)(S0)(C0.rstate)(R1.rstate ++ S0.rstate),
//    "(P!!) !C 2" -> NonDeterminedUnknownCase(C_)(R1, P_)(S0)(emptyState)(emptyState),
    "P!! (!C)"   -> ConflictingCase(S0, C0)(P_)(R1)(R1.rstate ++ C0.rstate)(R1.rstate),
    "(P!!) (!C)" -> ConflictingCase(S0, C_)(P_, R0)(Nil)(C_.rstate)(R0.rstate),
    "!!P !C"     -> MergeableCase(C0)(P1)(S0, R1)(C0.rstate ++ R1.rstate),
    "(!!P) !C"   -> CoveredBy("(P!!) !C"),
    "!!P (!C)"   -> ConflictingCase(S0, C0)(P_)(R1)(R1.rstate ++ C0.rstate)(R1.rstate),
    "(!!P) (!C)" -> CoveredBy("(P!!) (!C)"),
    "P!! 4X"     -> ConflictingCase(F1)(R0)(P_)(F1.rstate ++ P_.rstate)(R0.rstate),
    ...
    "(P!!) 4!"   -> ConflictingCase(S0)(P1, R1)(F0)(emptyState)(R1.rstate ++ F0.rstate),
...
//    "!!P (4!)"   -> NonDeterminedMergeableCase(F_, S0)(P_)(R1)(R1.rstate)(R1.rstate),
    ...
    "(P!!) 4!!"   -> ConflictingCase(P0, R0)(R1)(F1)(R0.rstate ++ F1.rstate)(R1.rstate),
    "P!! (4!!)"   -> ConflictingCase(R0)(R1, F1)(P0)(R0.rstate)(R1.rstate ++ P0.rstate),
    "(P!!) (4!!)" -> ConflictingCase(R0, P_)(R1, F_)(Nil)(R0.rstate)(R1.rstate),
    "!!P 4!!"     -> ConflictingCase(P_)(R0)(R1, F0)(R1.rstate ++ F0.rstate)(R0.rstate ++ R1.rstate),
    "(!!P) 4!!"   -> CoveredBy("(P!!) 4!!"),
    "!!P (4!!)"   -> ConflictingCase(P_)(F_, R1)(R0)(R0.rstate)(R0.rstate ++ R1.rstate),
    "(!!P) (4!!)" -> CoveredBy("(P!!) (4!!)"),
    "P!! PX"      -> MergeableCase(R0)(S1)(P0)(S1.rstate ++ R0.rstate),
    "(P!!) PX"    -> ConflictingCase(P_, R0)(P1)(Nil)(R0.rstate)(P1.rstate),
    ...
    "P!! (P!)"    -> CoveredBy("(P!) P!!"),
    "(P!!) (P!)"  -> CoveredBy("(P!) (P!!)"),
    "!!P P!"      -> ConflictingCase(S0)(P1)(P0, R1)(R1.rstate ++ S0.rstate)(R1.rstate ++ P0.rstate),
    "(!!P) P!"    -> CoveredBy("(P!!) P!"),
//    "!!P (P!)"    -> NonDeterminedMergeableCase(P_)(P_, S0)(R0)(R0.rstate)(R0.rstate),
    "(!!P) (P!)"  -> CoveredBy("(P!!) (P!)"),
    "P!! P!!"     -> MergeableCase(R1)(R0)(P1, P0)(R0.rstate ++ R1.rstate),
    "(P!!) P!!"   -> ConflictingCase(R0)(P_, R1)(P0)(R0.rstate)(R1.rstate ++ P0.rstate),
    "(P!!) (P!!)" -> ConflictingCase(P_, R0)(P_, R0)(Nil)(R0.rstate)(R0.rstate),
    "!!P P!!"     -> ConflictingCase(R1)(P0)(R0, P1)(R1.rstate ++ R0.rstate)(R0.rstate ++ P1.rstate),
    "(!!P) P!!"   -> CoveredBy("(P!!) P!!"),
    "(!!P) (P!!)" -> CoveredBy("(P!!) (P!!)"),
    "P!! !!X"     -> MergeableCase(R1)(R0)(P1)(R0.rstate ++ R1.rstate),
    "(P!!) !!X"   -> ConflictingCase(R1, P1)(R0)(Nil)(R1.rstate)(R0.rstate),
    "!!P !!X"     -> MergeableCase(P_)(Nil)(R1, R0)(R0.rstate ++ R1.rstate),
    "P!! !!4"     -> ConflictingCase(R0)(F1)(P0, R1)(R0.rstate ++ R1.rstate)(P0.rstate ++ R1.rstate),
    "(P!!) !!4"   -> ConflictingCase(R0, P_)(F_)(R1)(R0.rstate ++ R1.rstate)(R1.rstate),
    "P!! (!!4)"   -> CoveredBy("P!! (4!!)"),
    "(P!!) (!!4)" -> CoveredBy("(P!!) (4!!)"),
    ...
    "P!! CX"      -> ConflictingCase(R0)(C1)(P_)(R0.rstate)(C1.rstate ++ P_.rstate),
    ...
    "(P!!) C!"    -> ConflictingCase(S1)(P_, R0)(C1)(C1.rstate)(R0.rstate ++ C1.rstate),
...
//    "P!! (C!) 2"   -> NonDeterminedConflictCase(R0)(C1, S1)(P_)(R0.rstate)(C1.rstate),
    ...
    "(P!!) (C!) 2" -> ConflictingCase(P1, R1)(C0, S0)(Nil)(R1.rstate)(C0.rstate),
    "!!P C!"       -> ConflictingCase(P0)(S1)(R0, C1)(R0.rstate ++ C1.rstate)(R0.rstate ++ C1.rstate),
    "(!!P) C!"     -> CoveredBy("(P!!) C!"),
    "!!P (C!)"     -> CoveredBy("!!P (!C)"),
    "(!!P) (C!)"   -> CoveredBy("(P!!) (C!)"),
  ...
  val joinMergeabilityCases = List(
    "J S S"   -> ConflictingCase(S0)(S0on1)(J_)(J_.rstate ++ S0.rstate)(J_.rstate ++ S0on1.rstate),
    "J S S 2" -> MergeableCase(S0)(S0)(J_)(J_.rstate ++ S0.rstate ++ S0.rstate),
    "J S N"   -> MergeableCase(S0)(Nil)(J_)(J_.rstate ++ S0.rstate),
    "J S 4"   -> MergeableCase(S0)(F_on1)(J_)(J_.rstate ++ S0.rstate ++ F_on1.rstate),
    "J S 4 2" -> ConflictingCase(S0)(F_)(J_)(J_.rstate ++ S0.rstate)(J_.rstate ++ F_.rstate),
    "J S C"   -> ConflictingCase(S0)(C_)(J_)(J_.rstate ++ S0.rstate)(J_.rstate ++ C_.rstate),
    "J S C 2" -> MergeableCase(S0)(C_on1)(J_)(J_.rstate ++ S0.rstate ++ C_on1.rstate),
    "J S R"   -> MergeableCase(S0)(R1)(J_)(J_.rstate ++ S0.rstate ++ R1.rstate),
    "J S R 2" -> ConflictingCase(S0)(R0on1)(J_)(J_.rstate ++ S0.rstate)(J_.rstate ++ R0on1.rstate),
    "J S P"   -> ConflictingCase(S0)(P_)(J_)(J_.rstate ++ S0.rstate)(P_.rstate ++ J_.rstate),
    "J S P 2" -> MergeableCase(S0)(P_on1)(J_)(J_.rstate ++ S0.rstate),
    "J 4 4"   -> MergeableCase(F_)(F1)(J_)(J_.rstate ++ F_.rstate ++ F1.rstate),
    "J 4 4 2" -> MergeableCase(F_)(F_on1)(J_)(J_.rstate ++ F_.rstate ++ F_on1.rstate),
    "J 4 N"   -> MergeableCase(F_)(Nil)(J_)(J_.rstate ++ F_.rstate),
    "J 4 C"   -> MergeableCase(F_)(C_)(J_)(J_.rstate ++ F_.rstate ++ C_.rstate),
    "J 4 C 2" -> MergeableCase(F_)(C_on1)(J_)(J_.rstate ++ F_.rstate ++ C_on1.rstate),
    "J 4 R"   -> ConflictingCase(F_)(R1)(J_)(J_.rstate ++ F_.rstate)(J_.rstate ++ R1.rstate),
    "J 4 R 2" -> MergeableCase(F_)(R0on1)(J_)(J_.rstate ++ F_.rstate ++ R0on1.rstate),
    "J 4 P"   -> MergeableCase(F_)(P_)(J_)(J_.rstate ++ F_.rstate ++ P_.rstate),
    "J 4 P 2" -> MergeableCase(F_)(P_on1)(J_)(J_.rstate ++ F_.rstate ++ P_on1.rstate),
    "J C C"   -> MergeableCase(C_)(C1)(J_)(J_.rstate ++ C_.rstate ++ C1.rstate),
    "J C C 2" -> MergeableCase(C_)(C_on1)(J_)(J_.rstate ++ C_.rstate ++ C_on1.rstate),
    "J C R"   -> ConflictingCase(C_)(R1)(J_)(J_.rstate ++ C_.rstate)(J_.rstate ++ R1.rstate),
    "J C R 2" -> MergeableCase(C_)(R0on1)(J_)(J_.rstate ++ C_.rstate ++ R0on1.rstate),
    "J C P"   -> MergeableCase(C_)(P_)(J_)(J_.rstate ++ C_.rstate ++ P_.rstate),
    "J C P 2" -> MergeableCase(C_)(P_on1)(J_)(J_.rstate ++ C_.rstate ++ P_on1.rstate),
    "J C N"   -> MergeableCase(C_)(Nil)(J_)(J_.rstate ++ C_.rstate),
    "J R R"   -> ConflictingCase(R0)(R0on1)(J_)(J_.rstate ++ R0.rstate)(J_.rstate ++ R0on1.rstate),
    "J R R 2" -> MergeableCase(R0)(R0)(J_)(J_.rstate ++ R0.rstate ++ R0.rstate),
    "J R P"   -> ConflictingCase(R0)(P_)(J_)(J_.rstate ++ R0.rstate)(J_.rstate ++ P_.rstate),
    "J R P 2" -> MergeableCase(R0)(P_on1)(J_)(J_.rstate ++ R0.rstate ++ P_on1.rstate),
    "J R N"   -> MergeableCase(R0)(Nil)(J_)(J_.rstate ++ R0.rstate),
    "J P P"   -> MergeableCase(P1)(P0)(J_)(J_.rstate ++ P1.rstate ++ P0.rstate),
    "J P P 2" -> MergeableCase(P1)(P_on1)(J_)(J_.rstate ++ P1.rstate ++ P_on1.rstate),
    ...
    "S J S"   -> ConflictingCase(S0)(J_)(S0)(S0.rstate ++ S0.rstate)(S0.rstate ++ J_.rstate),
    "S J S 2" -> ConflictingCase(S0on1)(J_)(S0)(S0.rstate ++ S0on1.rstate)(S0.rstate ++ J_.rstate),
    ...
    "S J R"   -> ConflictingCase(R0)(J_)(S0)(R0.rstate ++ S0.rstate)(J_.rstate ++ S0.rstate),
    "S J R 2" -> ConflictingCase(R0on1)(J_)(S0)(R0on1.rstate ++ S0.rstate)(S0.rstate ++ J_.rstate),
    ...
    "R J S"   -> ConflictingCase(J_)(S1)(R0)(J_.rstate ++ R0.rstate)(S1.rstate ++ R0.rstate),
    "R J S 2" -> ConflictingCase(J_)(S1on1)(R0)(J_.rstate ++ R0.rstate)(R0.rstate),
    "R J 4"   -> MergeableCase(J_)(F1)(R0)(J_.rstate ++ R0.rstate ++ F1.rstate),
    "R J 4 2" -> ConflictingCase(J_)(F0)(R0)(J_.rstate ++ R0.rstate)(R0.rstate),
    "R J C"   -> InfiniteLoop(C0)(J_)(R0)(J_.rstate ++ R0.rstate),
    ...
    "R J R 2" -> ConflictingCase(R0on1)(J_)(R0)(R0on1.rstate ++ R0.rstate)(R0.rstate ++ J_.rstate),
    ...
    "P J S 2" -> ConflictingCase(J_)(S1)(P0)(J_.rstate ++ P0.rstate)(P0.rstate ++ S1.rstate),
    ...
    // Join match cases
    "JM N"   -> MergeableCase(S1, S0on1)(Nil)(J_)(emptyState),
    "JM N 2" -> MergeableCase(J_)(Nil)(S1, S0on1)(emptyState),
    "JM J"   -> ConflictingCase(S1, S0on1)(J_)(J_)(emptyState)(J_.rstate ++ J_.rstate),
    "JM J 2" -> ConflictingCase(J_)(J_)(S1, S0on1)(emptyState)(emptyState),
    "JM S"   -> ConflictingCase(S1, S0on1)(S1)(J_)(emptyState)(J_.rstate ++ S1.rstate),
    "JM S 2" -> ConflictingCase(J_)(S1)(S1, S0on1)(emptyState)(
      S1.rstate ++ S1.rstate ++ S0on1.rstate
    ),
    "JM 4"   -> ConflictingCase(J_)(F_)(S1, S0on1)(emptyState)(S0on1.rstate),
    "JM 4 2" -> ConflictingCase(S1, S0on1)(F_)(J_)(emptyState)(J_.rstate ++ F_.rstate),
    "JM C"   -> ConflictingCase(J_)(C_)(S1, S0on1)(emptyState)(S0on1.rstate ++ C_.rstate),
    "JM C 2" -> ConflictingCase(S1, S0on1)(C_)(J_)(emptyState)(J_.rstate ++ C_.rstate),
    "JM R"   -> ConflictingCase(S1, S0on1)(R1)(J_)(emptyState)(J_.rstate ++ R1.rstate),
    "JM R 2" -> ConflictingCase(J_)(R1)(S1, S0on1)(emptyState)(
      S1.rstate ++ S0on1.rstate ++ R1.rstate
    ),
    "JM P"   -> ConflictingCase(S1, S0on1)(P_)(J_)(emptyState)(J_.rstate ++ P_.rstate),
    "JM P 2" -> ConflictingCase(J_)(P_)(S1, S0on1)(emptyState)(S1.rstate ++ S0on1.rstate)
  )
